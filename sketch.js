...
function setup() {
    ...
    playerSprite.addAni('standing', 'assets/michael.jackson.png');
    playerSprite.addAni('left','assets/michael.jackson.png','assets/michael.jackson.png');
    playerSprite.addAni('right','assets/michael.jackson.png','assets/michael.jackson.png')
    playerSprite.addAni('jumping', 'michael.jackson.png');
